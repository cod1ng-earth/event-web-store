...
func (*TopicMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_topic_40f141c5856772f3, []int{0}
}
...
func _TopicMessage_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*TopicMessage)
	switch tag {
	case 1: // messages.stockCorrected
...
func (*StockCorrected) Descriptor() ([]byte, []int) {
	return fileDescriptor_topic_40f141c5856772f3, []int{1}
}
...
func init() { proto.RegisterFile("topic.proto", fileDescriptor_topic_40f141c5856772f3) }

var fileDescriptor_topic_40f141c5856772f3 = []byte{
